            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Questions et Réponses du Sondage</h1>
                    </div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body" style="max-height: 400px; overflow-y: auto;">
                ...
                <div class="table-responsive table-container">
                    ...
                    <!-- Vérifier si la liste des questions et réponses n'est pas vide -->
                    <c:if test="${empty questionreponses}">
                        <p>Aucune question et réponse trouvée.</p>
                    </c:if>
    
                    <!-- Boucle sur la liste des questions et réponses -->
                    <c:forEach var="qr" items="${questionreponses}">
                        <div class="question-item">
                            <div class="question">
                                <h5>Question ID: ${qr.idQuestion}</h5>
                                <p>${qr.texteQuestion}</p>
                            </div>
                            
                            <c:if test="${not empty qr.texteReponse}">
                                <div class="response">
                                    <h6>Réponse ID: ${qr.idReponse}</h6>
                                    <p>${qr.texteReponse}</p>
                                </div>
                            </c:if>
                            <hr class="my-4">
