                        ...
                        <div class="col-xl-8 col-lg-7 text-center">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Choisir le nombre de reponse pour chaque question :</h6>
                                </div>
                                <!-- Card Body -->
                                   <div class="card-body" style="height: 150px;">
   <div class="chart-area form-container">
    <form action="/Test/SondageServlet?action=choixnumreponses" method="POST" style="width:350px;">
    	<input type="hidden" name="numquestions" value="${numquestions}" required>
        <c:forEach var="i" begin="0" end="${numquestions-1}">
            <div>
                <label for="numresponses${i}" style="color:black">Nombre de réponses pour la question ${i+1}:</label>
                <input type="number" name="responses[${i}]" min="2" max="10" required><br>
            </div>
        </c:forEach>
        <button class="btn-stylish" type="submit">Suivant</button>
    </form>
    </div>
</div>
</div>
