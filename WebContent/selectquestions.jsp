...
if (sessionver == null){
    ...
    System.out.println("RESPMARKETING ROLE ENTERS Select questions.JSP");
%>
<html lang="en">
<style>.text-center {
    text-align: center;
                        ...
                        <div class="col-xl-8 col-lg-7 text-center">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Choisir le nombre de questions pour le sondage</h6>
                                </div>
                                <!-- Card Body -->
                                   <div class="card-body" style="height: 140px;">
   <div class="chart-area form-container">
        <form action="/Test/SondageServlet?action=choixquestion" method="POST">
            <label for="numberOfQuestions" style="color:black">Nombre de questions:</label>
            <input type="number" id="numberOfQuestions" name="numquestions" min="1" max="10" required=""><br>
            <button type="submit" class="btn-stylish">Suivant</button>
        </form>
    </div>
</div>
</div>
...
<%}
	...
	System.out.println(sessionver.getAttribute("role") + " tried to enter SELECTQUESTIONS.JSP");
    response.sendRedirect("login.jsp");
} %>
